...
const STR = {
  en: {
    ...
    smalltalk_thanks: "You're welcome! I'm here whenever you need me. Ask me anything about your health, or type *menu* to see all options.",
    smalltalk_ack: "👍 Anytime. Ask me a question, log a reading (e.g. `Fasting 110`), or type *menu* to see all options.",
    smalltalk_bye: "Take care! Keep logging your readings — I'll be here when you need me. 💚",
    smalltalk_hello: "Hello! How can I help you today? Ask me anything about your health, or type *menu* to see all options.",
    wsum_title: "🗓 *Your week at a glance*",
    wsum_readings: "🩸 Blood sugar: *{count}* readings, average *{avg} mg/dL* (lowest {min}, highest {max}).",
    wsum_no_readings: "🩸 No blood sugar readings logged this week.",
    wsum_inrange: "🎯 *{pct}%* of those readings were in your target range.",
    wsum_meds: "💊 Medication logged *{count}* times.",
    wsum_meds_none: "💊 No medication logged this week.",
    wsum_checkins: "📝 Check-ins: *{count}*.",
    wsum_streak: "🔥 You're on a *{days}-day* logging streak — well done.",
    wsum_watch_low: "⚠️ One or more readings were below 70 mg/dL. Lows are worth mentioning to your doctor.",
    wsum_watch_high: "📈 Your average is running high. Small, steady changes move this number.",
    wsum_watch_mid: "📊 Your average is a little above target — close, keep nudging it down.",
    wsum_watch_good: "✅ Your average is sitting in a healthy range. Keep doing what you're doing.",
    wsum_focus_log_more: "*Focus for next week:* log at least one reading every day — even one a day builds a pattern I can read.",
    wsum_focus_low: "*Focus for next week:* note what you ate and when before each low reading, and share that with your doctor.",
    wsum_focus_range: "*Focus for next week:* take a 15-minute walk after your largest meal of the day.",
    wsum_focus_meds: "*Focus for next week:* log your medicines each day so we can see how they line up with your readings.",
    wsum_focus_checkin: "*Focus for next week:* do a quick daily check-in so your week tells a fuller story.",
    wsum_focus_keep: "*Focus for next week:* keep your routine exactly as it is — consistency is what makes the difference.",
    joined_already: "You have already joined! Welcome to DrSaab,",
    welcome_eng:
  ...
  ur: {
    ...
    smalltalk_thanks: "آپ کا شکریہ! جب بھی ضرورت ہو میں حاضر ہوں۔ اپنی صحت کے بارے میں کچھ بھی پوچھیں، یا تمام آپشنز دیکھنے کے لیے *menu* لکھیں۔",
    smalltalk_ack: "👍 جی بالکل۔ کوئی سوال پوچھیں، ریڈنگ ریکارڈ کریں (مثلاً `Fasting 110`)، یا تمام آپشنز دیکھنے کے لیے *menu* لکھیں۔",
    smalltalk_bye: "اپنا خیال رکھیں! اپنی ریڈنگز ریکارڈ کرتے رہیں — جب ضرورت ہو میں یہیں ہوں۔ 💚",
    smalltalk_hello: "السلام علیکم! آج میں آپ کی کیا مدد کر سکتا ہوں؟ اپنی صحت کے بارے میں کچھ بھی پوچھیں، یا تمام آپشنز دیکھنے کے لیے *menu* لکھیں۔",
    wsum_title: "🗓 *آپ کے ہفتے کا خلاصہ*",
    wsum_readings: "🩸 بلڈ شوگر: *{count}* ریڈنگز، اوسط *{avg} mg/dL* (کم از کم {min}، زیادہ سے زیادہ {max})۔",
    wsum_no_readings: "🩸 اس ہفتے کوئی بلڈ شوگر ریڈنگ ریکارڈ نہیں ہوئی۔",
    wsum_inrange: "🎯 ان میں سے *{pct}%* ریڈنگز آپ کی ہدف حد میں تھیں۔",
    wsum_meds: "💊 ادویات *{count}* بار ریکارڈ ہوئیں۔",
    wsum_meds_none: "💊 اس ہفتے کوئی دوا ریکارڈ نہیں ہوئی۔",
    wsum_checkins: "📝 چیک اِن: *{count}*۔",
    wsum_streak: "🔥 آپ کا *{days} دن* کا سلسلہ جاری ہے — شاباش۔",
    wsum_watch_low: "⚠️ ایک یا زیادہ ریڈنگز 70 mg/dL سے کم تھیں۔ کم شوگر کا ذکر اپنے ڈاکٹر سے ضرور کریں۔",
    wsum_watch_high: "📈 آپ کی اوسط زیادہ چل رہی ہے۔ چھوٹی مگر مستقل تبدیلیاں اس نمبر کو بدلتی ہیں۔",
    wsum_watch_mid: "📊 آپ کی اوسط ہدف سے تھوڑی اوپر ہے — قریب ہیں، اسے مزید کم کرتے رہیں۔",
    wsum_watch_good: "✅ آپ کی اوسط صحت مند حد میں ہے۔ جو کر رہے ہیں ویسے ہی جاری رکھیں۔",
    wsum_focus_log_more: "*اگلے ہفتے کی توجہ:* روزانہ کم از کم ایک ریڈنگ ریکارڈ کریں — دن میں ایک ریڈنگ سے بھی پیٹرن بن جاتا ہے۔",
    wsum_focus_low: "*اگلے ہفتے کی توجہ:* ہر کم ریڈنگ سے پہلے آپ نے کیا اور کب کھایا، یہ نوٹ کریں اور اپنے ڈاکٹر کو بتائیں۔",
    wsum_focus_range: "*اگلے ہفتے کی توجہ:* دن کے سب سے بھاری کھانے کے بعد 15 منٹ کی چہل قدمی کریں۔",
    wsum_focus_meds: "*اگلے ہفتے کی توجہ:* روزانہ اپنی ادویات ریکارڈ کریں تاکہ ہم دیکھ سکیں وہ آپ کی ریڈنگز سے کیسے جڑی ہیں۔",
    wsum_focus_checkin: "*اگلے ہفتے کی توجہ:* روزانہ مختصر چیک اِن کریں تاکہ آپ کے ہفتے کی مکمل تصویر بن سکے۔",
    wsum_focus_keep: "*اگلے ہفتے کی توجہ:* اپنا معمول بالکل ایسے ہی رکھیں — تسلسل ہی اصل فرق ڈالتا ہے۔",
    joined_already: "آپ پہلے ہی شامل ہو چکے ہیں! DrSaab میں خوش آمدید،",
    welcome_eng:
    ...
    // Strings that previously fell back to English (menus, check-in,
    // My Health, food help, reminders) — added 2026-09-22.
    btn_take_photo_lab: "📸 تصویر لیں",
    lab_pdf_unreadable: "مجھے PDF مل گئی لیکن اس میں سے کوئی متن نہیں پڑھ سکا — شاید یہ اسکین شدہ تصویر ہے۔ براہِ کرم رپورٹ کی تصویر یا اسکرین شاٹ بھیجیں۔",
    lab_unsupported_file: "یہ فائل کی قسم ابھی سپورٹ نہیں ہوتی — براہِ کرم اپنی رپورٹ کی تصویر، امیج فائل یا PDF بھیجیں۔",
    voice_note_saved: "شکریہ — آپ کا وائس نوٹ مل گیا اور محفوظ کر لیا۔ جلد مدد کے لیے آپ اپنا سوال لکھ بھی سکتے ہیں۔",
    upgrade_intro: "💎 *DrSaab پلانز*\n\n*Starter (مفت)* — روزانہ چیک اِن، شوگر اور دوا کا ریکارڈ، کھانے کا ریکارڈ، بنیادی Ask DrSaab، چند لیب رپورٹس کی وضاحت، اہداف، مفت چیلنجز اور سیکھنے کی لائبریری۔\n\n*Consistency Coach* — Starter کی ہر چیز، اس کے ساتھ مکمل Ask DrSaab، مزید لیب وضاحتیں، چاروں اسکورز کے ساتھ میری پیش رفت، ہفتہ وار اور ماہانہ رپورٹس، ڈاکٹر کے لیے رپورٹ، اسمارٹ یاد دہانیاں اور تمام چیلنجز۔\n\n*Executive Coach* — Consistency Coach کی ہر چیز، اس کے ساتھ ڈاکٹر کیس ریویو، لائیو کوچ سیشنز، ہر 3 ماہ بعد ایگزیکٹو ریویو، ترجیحی مدد اور پریمیم مواد۔\n\nآپ کا پلان: *{plan}*",
    scores_body: "🔥 تسلسل: *{consistency}*\n💪 حوصلہ: *{motivation}*\n🩺 خطرہ: *{risk}*\n💬 مشغولیت: *{engagement}*",
    score_consistency: "تسلسل",
    score_motivation: "حوصلہ",
    score_risk: "خطرہ",
    score_engagement: "مشغولیت",
    reports_intro: "ایک رپورٹ منتخب کریں۔ آپ یہ اپنے ڈاکٹر کے ساتھ شیئر کر سکتے ہیں۔",
    btn_report_weekly: "🗓 ہفتہ وار خلاصہ",
    btn_report_monthly: "📅 ماہانہ رپورٹ",
    btn_report_doctor: "🩺 ڈاکٹر رپورٹ",
    report_monthly_generating: "📅 آپ کی ماہانہ رپورٹ تیار ہو رہی ہے…",
    no_data_month: "اس مہینے ابھی کافی ڈیٹا نہیں ہے۔ ریکارڈ کرتے رہیں اور بعد میں دیکھیں!",
    doctor_report_title: "🩺 *ڈاکٹر رپورٹ* — {name}",
    doctor_report_body: "مدت: پچھلے 30 دن\nذیابیطس: {diabetes}\nتازہ ترین HbA1c (خود بتایا گیا): {hba1c}\nاندازاً HbA1c (ریکارڈ سے): {est_hba1c}\nBMI: {bmi}\n\nشوگر ریڈنگز: {gcount}\nاوسط: {gavg} mg/dL  (کم از کم {gmin} / زیادہ سے زیادہ {gmax})\nنارمل حد میں ریڈنگز: {ginrange}%\nدوا کے ریکارڈ: {mcount}\nچیک اِن: {hcount}\nموجودہ سلسلہ: {streak} دن\n\n_DrSaab سے خود رپورٹ کردہ ڈیٹا۔ صرف معلومات کے لیے؛ یہ تشخیص نہیں ہے۔_",
    challenges_intro: "حوصلہ برقرار رکھنے کے لیے کسی چیلنج میں شامل ہوں۔ شامل ہونے کے لیے ایک پر ٹیپ کریں۔",
    chl_a1c: "90 دن کا HbA1c چیلنج",
    chl_weight: "وزن کم کرنے کا چیلنج",
    chl_walking: "چہل قدمی کا چیلنج",
    chl_consistency: "تسلسل کا چیلنج",
    chl_ramadan: "رمضان صحت چیلنج",
    chl_doctor: "ڈاکٹر چیلنج (کوڈ درکار)",
    chl_corporate: "کارپوریٹ چیلنج (کوڈ درکار)",
    challenge_joined: "✅ آپ *{name}* میں شامل ہو گئے۔ روزانہ ریکارڈ کرتے رہیں — میں آپ کی پیش رفت دیکھتا رہوں گا۔",
    challenge_code_prompt: "*{name}* کا کوڈ درج کریں (اپنے ڈاکٹر یا کمپنی سے)، یا واپس دبائیں۔",
    challenge_already: "آپ پہلے سے *{name}* میں شامل ہیں۔",
    my_challenges_title: "آپ کے جاری چیلنجز:",
    my_challenges_none: "آپ ابھی تک کسی چیلنج میں شامل نہیں ہوئے۔",
    btn_my_challenges: "📋 میرے چیلنجز",
    exec_intro: "Executive Coach ممبران کے لیے خصوصی مدد۔ ایک سروس منتخب کریں، ہماری ٹیم آپ سے رابطہ کرے گی۔",
    btn_exec_doctor: "🩺 ڈاکٹر ریویو",
    btn_exec_session: "📞 لائیو کوچ سیشن",
    btn_exec_review: "📈 ایگزیکٹو ریویو",
    btn_exec_priority: "⚡ ترجیحی مدد",
    btn_exec_content: "📚 پریمیم مواد",
    exec_requested: "✅ درخواست موصول ہو گئی: *{service}*۔ ہماری ٹیم آپ سے رابطہ کرے گی۔ (حوالہ #{ref})",
    executive_required: "⭐ یہ *Executive Coach* فیچر ہے۔\nڈاکٹر ریویو، لائیو کوچ سیشنز، ترجیحی مدد اور پریمیم مواد کے لیے Executive Coach پر اپ گریڈ کریں۔",
    profileq_intro: "آپ کی کوچنگ کو بہتر بنانے کے لیے ایک مختصر سوال (چھوڑنے کے لیے Skip دبائیں):",
    profileq_saved: "شکریہ — نوٹ کر لیا۔ 👍",
    profileq_done: "آپ کی پس منظر کی پروفائل مکمل ہو گئی۔ شکریہ!",
    btn_checkin: "🩺 چیک اِن",
    btn_foodhelp: "🍽️ کھانے میں مدد",
    btn_checkreport: "📋 میری رپورٹ سمجھائیں",
    btn_askdrsaab: "💬 DrSaab سے پوچھیں",
    btn_more: "🌟 مزید",
    btn_shortcuts: "⚡ فوری کمانڈز",
    btn_main_menu: "🏠 مرکزی مینو",
    btn_myhealth: "❤️ میری صحت",
    btn_mh_start: "1️⃣ شروع کریں",
    btn_mh_yes: "1️⃣ جی ہاں",
    btn_mh_edit: "2️⃣ تبدیل کریں",
    btn_mh_skip: "چھوڑیں ⏭",
    btn_mh_ctx_fasting: "نہار منہ",
    btn_mh_ctx_random: "رینڈم",
    btn_mh_ctx_postmeal: "کھانے کے بعد",
    mh_intro: "❤️ *میری صحت*\n\nمیں آپ کی صحت کے بارے میں جتنا زیادہ جانوں گا، اتنا ہی بہتر مشورہ دے سکوں گا۔\n\nاس میں صرف 2 منٹ لگیں گے۔",
    mh_resume_welcome: "❤️ *میری صحت*\n\nخوش آمدید! پچھلی بار ہم نے {done} کے بارے میں بات کی تھی۔\n\nآئیے آگے بڑھتے ہیں۔",
    mh_resume_welcome_nostep: "❤️ *میری صحت*\n\nخوش آمدید! آئیے وہیں سے شروع کرتے ہیں جہاں چھوڑا تھا۔",
    mh_recap_aboutyou: "آپ کی بنیادی معلومات",
    mh_recap_conditions: "آپ کی بیماریاں",
    mh_recap_medications: "آپ کی ادویات",
    mh_recap_metrics: "آپ کے صحت کے نمبرز",
    mh_recap_lifestyle: "آپ کا طرزِ زندگی",
    mh_recap_goal: "آپ کا ہدف",
    mh_recap_city: "آپ کا شہر",
    mh_recap_anything: "دیگر معلومات",
    mh_question_of: "*سوال {n} از {total}*",
    mh_q_aboutyou: "👋 *آپ کے بارے میں*\n\n{known_block}{ask}",
    mh_q_aboutyou_ask_confirm: "کیا سب کچھ درست ہے؟ برقرار رکھنے کے لیے *ok* لکھیں، یا اکائی کے ساتھ تبدیلی لکھیں (مثلاً \"weight 76 kg\"، \"female, 32 years\")۔",
    mh_q_aboutyou_ask_missing: "براہِ کرم اپنا *{missing}* بھی بتائیں — اکائی کے ساتھ، مثلاً *78 kg*، *174 cm*، *42 years*۔",
    mh_q_aboutyou_ask_none: "اپنی *جنس*، *عمر*، *قد* اور *موجودہ وزن* بتائیں — اسپیس یا کاما سے الگ کر کے، اکائی کے ساتھ (مثلاً \"female, 32 years, 168 cm, 62 kg\")۔",
    mh_aboutyou_need_units: "مجھے *{numbers}* نظر آئے لیکن اکائی نہیں، اس لیے سمجھ نہیں آیا کون سا نمبر کس چیز کا ہے۔ براہِ کرم ہر نمبر کے ساتھ اکائی لکھیں — مثلاً *78 kg*، *174 cm*، *42 years*۔",
    mh_q_aboutyou_missing_gender: "جنس",
    mh_q_aboutyou_missing_age: "عمر",
    mh_q_aboutyou_missing_height: "قد",
    mh_q_aboutyou_missing_weight: "موجودہ وزن",
    mh_aboutyou_line_gender: "• جنس: *{value}*",
    mh_aboutyou_line_age: "• عمر: *{value}*",
    mh_aboutyou_line_height: "• قد: *{value} cm*",
    mh_aboutyou_line_weight: "• وزن: *{value} kg*",
    mh_aboutyou_ok_ack: "بہت خوب — تصدیق کا شکریہ۔",
    mh_aboutyou_updated: "✅ آپ کی بنیادی معلومات اپ ڈیٹ ہو گئیں۔",
    mh_none_aboutyou: "مجھے کوئی تفصیل سمجھ نہیں آئی۔ کچھ اس طرح لکھیں: \"male, 42 years, 174 cm, 78 kg\" — یا صرف وہ حصے جو باقی ہیں۔",
    mh_q_conditions: "❤️ *آپ کی صحت*\n\nکیا ذیابیطس کے علاوہ آپ کو کوئی اور بیماری ہے؟ مثلاً ہائی یا لو بلڈ پریشر، کولیسٹرول، دل کی بیماری وغیرہ۔",
    mh_conditions_none_ack: "👍 نوٹ کر لیا — کوئی اور بیماری نہیں۔",
    mh_q_city: "📍 *آپ کا شہر*\n\nآخر میں، آپ کس شہر میں رہتے ہیں؟ اس سے میں آپ کے قریب مفید سروسز تجویز کر سکوں گا۔",
    mh_none_city: "مجھے شہر کا نام سمجھ نہیں آیا۔ بس اپنے شہر کا نام لکھیں (مثلاً \"Lahore\")، یا Skip دبائیں۔",
    mh_city_saved: "📍 ٹھیک ہے — *{city}*۔",
    mh_q_medications: "💊 *ادویات*\n\nآپ اس وقت کون سی ادویات یا سپلیمنٹس لیتے ہیں؟\n\nآپ یہ کر سکتے ہیں:\n• ان کے نام لکھیں\n• دوائیوں کے ڈبوں کی تصویر بھیجیں\n• اپنے نسخے کی تصویر بھیجیں",
    mh_q_metrics: "📊 *صحت کے نمبرز*\n\nاپنے حالیہ صحت کے نمبرز بتائیں جو آپ کو معلوم ہوں — HbA1c، شوگر، بلڈ پریشر، وزن، کولیسٹرول وغیرہ۔\n\nجو بھی معلوم ہوں وہ لکھ دیں۔",
    mh_q_lifestyle: "🌿 *آپ کا طرزِ زندگی*\n\nاپنے طرزِ زندگی کے بارے میں تھوڑا بتائیں — سگریٹ نوشی، شراب، ورزش اور نیند۔\n\nبس عام انداز میں جواب دیں۔",
    mh_q_goal: "🎯 *آپ کا ہدف*\n\nاگلے چند مہینوں میں آپ سب سے زیادہ کس چیز کو بہتر بنانا چاہتے ہیں؟\n\nمثال: بہتر شوگر، وزن کم کرنا، مسلز بنانا، صحت مند رہنا، 5K دوڑنا۔",
    mh_q_anything: "😊 *کچھ اور؟*\n\nکوئی اہم بات جو DrSaab کو معلوم ہونی چاہیے؟ آپریشن، چوٹ، الرجی، حمل یا کچھ اور۔ اگر نہیں، تو بس *Nothing else* لکھ دیں۔",
    mh_anything_none_ack: "ٹھیک ہے — مزید کچھ نوٹ کرنے کو نہیں۔",
    mh_anything_saved: "✅ نوٹ کر لیا۔ بتانے کا شکریہ۔",
    mh_confirm_intro: "میں نے یہ ریکارڈ کیا ہے:\n\n{lines}\n\nکیا یہ درست ہے؟",
    mh_edit_reask: "کوئی بات نہیں — دوبارہ لکھ دیں۔",
    mh_saved_ok: "✅ محفوظ ہو گیا۔",
    mh_none_conditions: "مجھے کوئی بیماری سمجھ نہیں آئی۔ آپ لکھ سکتے ہیں (مثلاً \"Type 2 diabetes, high blood pressure\")، یا Skip دبائیں۔",
    mh_none_medications: "مجھے کوئی دوا سمجھ نہیں آئی۔ آپ نام لکھ سکتے ہیں، ڈبوں یا نسخے کی تصویر بھیج سکتے ہیں، یا Skip دبائیں۔",
    mh_none_metrics: "مجھے کوئی نمبر سمجھ نہیں آیا۔ آپ لکھ سکتے ہیں (مثلاً \"HbA1c 7.2, weight 81kg\")، یا Skip دبائیں۔",
    mh_glucose_context_q: "ٹھیک ہے — یہ ریڈنگ *نہار منہ*، *رینڈم* یا *کھانے کے بعد* کی تھی؟",
    mh_setup_complete: "❤️ فی الحال مجھے اتنا ہی چاہیے تھا — آپ کی صحت کی پروفائل تیار ہے۔ شکریہ!",
    mh_summary_header: "❤️ *میری صحت*\n\nآپ کی صحت کے بارے میں مجھے اس وقت یہ معلوم ہے:",
    mh_summary_footer: "کچھ بھی اپ ڈیٹ کرنے کے لیے بس نیچے لکھ دیں۔\n\nمثالیں:\n\"My weight is now 79 kg.\"\n\"My HbA1c is 6.8.\"\n\"میں نے Tagipmet لینا چھوڑ دی ہے۔\"\n\"مجھے فیٹی لیور کی تشخیص بھی ہوئی ہے۔\"",
    mh_summary_dash: "—",
    mh_lbl_conditions: "🩺 *بیماریاں:*",
    mh_lbl_meds: "💊 *ادویات:*",
    mh_lbl_hba1c: "🧪 *تازہ ترین HbA1c:*",
    mh_lbl_glucose: "🩸 *تازہ ترین شوگر:*",
    mh_lbl_weight: "⚖️ *وزن:*",
    mh_lbl_bp: "🫀 *بلڈ پریشر:*",
    mh_lbl_smoking: "🚬 *سگریٹ نوشی:*",
    mh_lbl_activity: "🏃 *جسمانی سرگرمی:*",
    mh_lbl_goal: "🎯 *ہدف:*",
    mh_lbl_city: "📍 *شہر:*",
    mh_smoking_smoker: "سگریٹ پیتے ہیں",
    mh_smoking_non_smoker: "سگریٹ نہیں پیتے",
    mh_smoking_ex_smoker: "سگریٹ چھوڑ چکے ہیں",
    mh_update_hint: "بس بتائیں کیا بدلا ہے، میں آپ کی صحت کی پروفائل اپ ڈیٹ کر دوں گا۔\n\nمثالیں: \"My fasting sugar was 104\"، \"I now weigh 76 kg\"، \"میں نے Ozempic شروع کر دی ہے۔\"",
    mh_update_saved: "✅ آپ کی صحت کی پروفائل اپ ڈیٹ ہو گئی۔",
    btn_mh_update_profile: "✏️ پروفائل اپ ڈیٹ کریں",
    btn_mh_main_menu: "🏠 مرکزی مینو",
    mh_menu_title: "❤️ *میری صحت*\n\nآپ کیا کرنا چاہیں گے؟",
    btn_mh_goals: "🎯 اہداف",
    btn_mh_summary: "📋 میری صحت کا خلاصہ",
    mh_goals_prompt_first: "🎯 *اہداف*\n\nآئیے آپ کے صحت کے اہداف طے کرتے ہیں۔ مجھے اپنے چند قابلِ حصول اہداف بتائیں۔\n\nمثلاً: 5 کلو وزن کم کرنا، HbA1c میں 1% کمی، ہفتے میں 3 بار جم جانا وغیرہ۔",
    mh_goals_update_prompt: "ضرور — اپنے نئے اہداف بتائیں، میں پرانے اہداف کی جگہ یہ محفوظ کر دوں گا۔\n\nمثلاً: 5 کلو وزن کم کرنا، HbA1c میں 1% کمی، ہفتے میں 3 بار جم جانا وغیرہ۔",
    mh_goals_stored: "🎯 *اہداف*\n\nآپ کے محفوظ کردہ اہداف یہ ہیں:\n\n{goals}\n\nکیا آپ انہیں اپ ڈیٹ کرنا چاہتے ہیں؟",
    btn_mh_goals_yes: "✏️ ہاں، اپ ڈیٹ کریں",
    btn_mh_goals_no: "👍 نہیں، یہی رکھیں",
    mh_goals_saved: "✅ *اہداف محفوظ ہو گئے:*\n\n{goals}\n\nمیں آپ کی رپورٹس اور پیش رفت کے تجزیے میں انہیں بنیاد کے طور پر استعمال کروں گا۔",
    mh_goals_kept: "👍 آپ کے اہداف میں کوئی تبدیلی نہیں ہوئی۔",
    mh_goals_empty_hint: "براہِ کرم اپنے اہداف ایک پیغام میں لکھیں — مثلاً: 5 کلو وزن کم کرنا، HbA1c میں 1% کمی۔",
    btn_mh_trends: "📈 رجحانات",
    mh_trends_title: "📈 *صحت کے رجحانات* _(پچھلے {days} دن)_",
    mh_trends_nodata: "📈 *صحت کے رجحانات*\n\nابھی میرے پاس آپ کا کوئی صحت کا ڈیٹا نہیں ہے۔ رجحانات دیکھنے کے لیے باقاعدگی سے ڈیٹا شامل کریں — چیک اِن کے ذریعے اپنی شوگر، HbA1c اور وزن ریکارڈ کریں۔ روزانہ ایک ریڈنگ سے بھی جلد رجحان بن جاتا ہے۔",
    mh_trends_nogoals: "🎯 آپ نے ابھی تک کوئی ہدف طے نہیں کیا۔ میری صحت ← اہداف میں انہیں شامل کریں، میں بہتر تجزیے کے لیے آپ کے رجحانات کا ان سے موازنہ کروں گا۔",
    mh_tr_fasting: "🩸 *نہار منہ شوگر*",
    mh_tr_random: "🩸 *رینڈم شوگر*",
    mh_tr_hba1c: "🧪 *HbA1c*",
    mh_tr_weight: "⚖️ *وزن*",
    mh_tr_name_fasting: "نہار منہ شوگر",
    mh_tr_name_random: "رینڈم شوگر",
    mh_tr_name_hba1c: "HbA1c",
    mh_tr_name_weight: "وزن",
    mh_tr_glucose_stats: "{count} ریڈنگز · اوسط {avg} mg/dL · {pct}% نارمل حد میں",
    mh_tr_glucose_move: "شروع کی اوسط {early} ← حالیہ اوسط {late} mg/dL ({arrow} {delta}، {word})",
    mh_tr_latest: "تازہ ترین: {value} بتاریخ {date}",
    mh_tr_limited: "صرف {count} ریکارڈ میں ہیں — ابھی رجحان کے لیے کافی نہیں۔ آخری اندراجات:",
    mh_tr_entry: "• {date} — {value}",
    mh_tr_change: "{from} ({fromDate}) ← {to} ({toDate}): {arrow} {delta}، {word}",
    mh_tr_word_improving: "بہتر ہو رہا ہے",
    mh_tr_word_rising: "بڑھ رہا ہے",
    mh_tr_word_steady: "مستحکم",
    mh_tr_word_down: "کم",
    mh_tr_word_up: "زیادہ",
    mh_tr_goals_header: "🎯 *آپ کے اہداف کے مقابلے میں*",
    mh_tr_goal_done: "• {goal} — ✅ حاصل ہو گیا (اب {current})",
    mh_tr_goal_relative: "• {goal} — {arrow} اب تک {achieved}، باقی {remaining}{note}",
    mh_tr_goal_wrongway: " (الٹی سمت جا رہا ہے — آئیے اسے درست کریں)",
    mh_tr_goal_absolute: "• {goal} — اب {current}، ہدف {target} (باقی {gap})",
    mh_tr_goal_watch: "• {goal} — اب {current} ({date} کو {baseline} تھا)",
    mh_tr_goal_nodata: "• {goal} — ابھی تک کوئی {metric} ریکارڈ نہیں ہوا، اس لیے میں اسے ناپ نہیں سکتا",
    mh_tr_goal_unmeasured: "• {goal} — میں ابھی آپ کے ریکارڈ سے اسے ناپ نہیں سکتا",
    mh_tr_not_tracked: "_ابھی ریکارڈ نہیں ہو رہا: {list}۔ ان کے رجحانات دیکھنے کے لیے انہیں چیک اِن کے ذریعے ریکارڈ کریں۔_",
    mh_update_profile_confirm: "صحت کی پروفائل دوبارہ شروع کرنے پر 7 سوالات پھر سے پوچھے جائیں گے۔ آپ کی موجودہ بیماریاں، ادویات اور ریکارڈ محفوظ رہیں گے۔ جاری رکھیں؟",
    btn_mh_update_yes: "✅ ہاں، دوبارہ شروع",
    btn_mh_update_no: "↩️ منسوخ کریں",
    btn_p_type1: "🤝 ٹائپ 1 کمیونٹی",
    btn_p_type2: "🩸 ٹائپ 2 ذیابیطس",
    btn_p_prediabetes: "🌱 پری ذیابیطس",
    btn_p_healthier: "🌟 بہتر میں",
    btn_p_gestational: "🤰 حمل کی ذیابیطس",
    profile_menu_stub: "یہ حصہ ابھی تیار ہو رہا ہے — مجھے بتائیں آپ کو کس چیز میں مدد چاہیے، میں پوری کوشش کروں گا۔",
    checkin_title: "🩺 *چیک اِن* — آپ کیا ریکارڈ کرنا چاہیں گے؟",
    btn_ci_bloodsugar: "🩸 بلڈ شوگر",
    btn_ci_medication: "💊 ادویات",
    btn_ci_weight: "⚖️ وزن",
    btn_ci_activity: "🚶 جسمانی سرگرمی",
    btn_ci_symptoms: "❤️ طبیعت کا حال",
    foodhelp_title: "🍽️ *کھانے میں مدد* — نیچے دیے گئے آپشنز میں سے ایک منتخب کریں:",
    btn_fh_analyze: "📸 میرے کھانے کا تجزیہ",
    btn_fh_caneat: "🥗 میں کیا کھا سکتا ہوں؟",
    btn_fh_restaurant: "🍽️ ریسٹورنٹ رہنمائی",
    btn_fh_label: "🏷️ لیبل اسکین کریں",
    btn_fh_snacks: "🥜 صحت مند اسنیکس",
    more_title: "⚙️ *مزید*",
    btn_more_reminders: "⏰ یاد دہانیاں",
    btn_more_language: "🌐 زبان",
    btn_more_plan: "⭐ میرا پلان",
    btn_more_subscription: "💳 سبسکرپشن",
    btn_more_support: "🛟 سپورٹ سے رابطہ",
    btn_more_goals: "🎯 اہداف",
    btn_more_challenges: "🏆 چیلنجز",
    btn_more_executive: "⭐ ایگزیکٹو سروسز",
    profile_t1: "ٹائپ 1 ذیابیطس",
    profile_t2: "ٹائپ 2 ذیابیطس",
    profile_child: "ذیابیطس والے بچے / نوجوان",
    profile_gestational: "حمل کی ذیابیطس",
    profile_newly: "حال ہی میں تشخیص",
    bs_prompt_v2: "آئیے آپ کی شوگر ریکارڈ کرتے ہیں! 🩸\nاپنی ریڈنگ بھیجیں اور بتائیں کہ یہ *Fasting* (نہار منہ)، *Random* یا *HbA1c* ہے۔\n\n_مثالیں:_ `Fasting 112`، `Random 145`، `Fasting 6.2`، `HbA1c 7.2`",
    bs_first_confirm: "✅ *ہو گیا!* آپ کی پہلی شوگر ریڈنگ محفوظ ہو گئی۔\n\nہر سفر ایک نمبر سے شروع ہوتا ہے۔ اپنی ریڈنگز ریکارڈ کرتے رہیں تاکہ میں وقت کے ساتھ آپ کی پیش رفت دکھا سکوں۔\n\nاگلی بار مینو کے بغیر بس یہ لکھیں:\n`Log random 125`",
    bs_confirm: "✅ *شوگر محفوظ ہو گئی۔*\n\nآپ اپنی ذیابیطس کا ایک مفید ریکارڈ بنا رہے ہیں۔ جاری رکھیں!\n\n_ٹپ:_ اگلی بار بس لکھیں: `Log fasting 102`",
    bs_reminder_offer: "کیا آپ باقاعدگی سے شوگر چیک کرنے کی یاد دہانی چاہیں گے؟",
    bs_reminder_yes: "👍 ٹھیک ہے! اگر آپ نے کافی دیر سے شوگر ریکارڈ نہ کی تو میں آپ کو یاد دلا دوں گا۔",
    bs_reminder_no: "👍 ٹھیک ہے! میں شوگر کی کوئی یاد دہانی نہیں بھیجوں گا۔ آپ کسی بھی وقت انہیں دوبارہ آن کر سکتے ہیں۔",
    bs_invalid: "ایک نمبر بھیجیں (مثلاً `Fasting 112` یا `Random 6.5`)۔",
    weight_prompt_v2: "آئیے آپ کا وزن ریکارڈ کرتے ہیں۔ ⚖️\nبس اپنا موجودہ وزن بھیج دیں۔\n\n_مثال:_ `72.5 kg`",
    weight_first_confirm: "✅ *آپ کا وزن ریکارڈ ہو گیا۔*\n\nیہ آپ کا پہلا وزن کا اندراج ہے۔ باقاعدگی سے ریکارڈ کرتے رہیں تاکہ میں وقت کے ساتھ آپ کی پیش رفت دکھا سکوں۔\n\nاگلی بار بس لکھیں: `Log weight 72.5`",
    weight_confirm: "✅ *وزن ریکارڈ ہو گیا۔*",
    weight_trend: "📈 آپ اپنے وزن کا ریکارڈ بنا رہے ہیں۔\nباقاعدہ وزن کرنے سے روزمرہ تبدیلیوں کے بجائے لمبے عرصے کی پیش رفت کا پتا چلتا ہے۔",
    activity_prompt_v2: "آئیے آپ کی سرگرمی ریکارڈ کرتے ہیں۔ 🚶\nبتائیں آج آپ نے کیا کیا اور اگر معلوم ہو تو کتنی دیر۔\n\n_مثالیں:_ `Walked 30 minutes`، `Gym for 1 hour`، `8,000 steps`، `Played cricket`",
    activity_first_confirm: "✅ *آپ کی سرگرمی ریکارڈ ہو گئی۔*\n\nیہ آپ کا پہلا سرگرمی کا اندراج ہے۔ اپنی سرگرمیاں ریکارڈ کرتے رہیں تاکہ میں وقت کے ساتھ آپ کی پیش رفت دکھا سکوں۔\n\nاگلی بار بس لکھیں: `Log walked 30 min`",
    activity_confirm: "✅ *سرگرمی ریکارڈ ہو گئی۔*",
    activity_trend: "📈 آپ اپنی سرگرمی کا ریکارڈ بنا رہے ہیں۔\nہر سرگرمی اہم ہے اور مجھے آپ کے روزمرہ معمول کو سمجھنے میں مدد دیتی ہے۔",
    wb_prompt: "آج آپ کیسا محسوس کر رہے ہیں؟ ❤️",
    wb_btn_great: "😄 بہت اچھا",
    wb_btn_good: "🙂 اچھا",
    wb_btn_okay: "😐 ٹھیک ٹھاک",
    wb_btn_notgreat: "😕 زیادہ اچھا نہیں",
    wb_btn_poor: "😞 برا",
    wb_reply_great: "😊 یہ سن کر بہت خوشی ہوئی! ایسے ہی جاری رکھیں۔",
    wb_reply_good: "👍 سن کر خوشی ہوئی۔ آئیے یہ رفتار برقرار رکھیں۔",
    wb_reply_okay: "💙 بتانے کا شکریہ۔ کچھ دن بس ٹھیک ٹھاک ہوتے ہیں، اور یہ بالکل ٹھیک ہے۔",
    wb_reply_notgreat: "❤️ یہ سن کر افسوس ہوا۔\n\n*آج آپ کو کس بات نے پریشان کیا؟*",
    wb_reply_poor: "❤️ مجھے افسوس ہے کہ آج آپ کا دن مشکل ہے۔\n\n*مجھے تھوڑا بتائیں کیا ہو رہا ہے۔*",
    wb_note_saved: "بتانے کا شکریہ۔ میں اگلے چیک اِن میں اسے ذہن میں رکھوں گا۔",
    wb_trend: "📈 آپ باقاعدگی سے چیک اِن کر رہے ہیں۔ اس سے مجھے سمجھنے میں مدد ملتی ہے کہ آپ وقت کے ساتھ کیسے ہیں — صرف آج کیسا محسوس کر رہے ہیں وہ نہیں۔",
    med_setup_prompt: "آئیے آپ کی ادویات سیٹ کرتے ہیں۔ 💊\nآپ یہ کر سکتے ہیں:\n\n📷 یہیں چیٹ میں اپنی ادویات یا نسخے کی *تصویر بھیجیں* (ایک تصویر میں کئی دوائیں ہوں تو بھی ٹھیک ہے)، یا\n\n✍️ ایک پیغام میں *اپنی ادویات لکھیں*۔\n\n_مثال:_\n• Metformin 500mg twice daily\n• Rosuvastatin 10mg once daily\n• Humalog insulin 8 units before breakfast\n• Lantus insulin 20 units at bedtime",
    med_photo_soon: "📷 تصویر سے دوا پڑھنے کی سہولت جلد آ رہی ہے۔ ابھی کے لیے براہِ کرم اپنی ادویات لکھ دیں — آپ ایک پیغام میں کئی دوائیں لکھ سکتے ہیں۔",
    med_confirm_intro: "مجھے یہ سمجھ آیا:\n\n{lines}\n\nکیا سب کچھ درست ہے؟",
    med_edit_ask: "کوئی بات نہیں — درستگی کے ساتھ دوا دوبارہ لکھیں۔ آپ ایک پیغام میں کئی دوائیں لکھ سکتے ہیں۔",
    med_add_ask: "بہت خوب — اگلی دوا (یا دوائیں) ایک پیغام میں بھیجیں۔",
    med_saved_ok: "✅ محفوظ ہو گیا۔ آپ کسی بھی وقت *ادویات* مینو سے اپنی ادویات اپ ڈیٹ کر سکتے ہیں۔",
    med_setup_none: "مجھے اس پیغام میں کوئی دوا نہیں ملی۔ کچھ اس طرح لکھیں: `Metformin 500mg twice daily`۔",
    med_btn_yes: "✅ جی ہاں",
    med_btn_edit: "✏️ تبدیل کریں",
    med_btn_add: "➕ ایک اور شامل کریں",
    medcp_offer: "کیا آپ چاہیں گے کہ DrSaab باقاعدگی سے دوا لینے میں آپ کی مدد کرے؟",
    medcp_yes: "🎯 شامل ہو گئے۔ پہلے ہفتے میں عادت بنانے کے لیے روزانہ ایک بار پوچھوں گا۔",
    medcp_no: "👍 ٹھیک ہے — میں چیک اِن کے بغیر صرف آپ کی ادویات کی فہرست محفوظ کروں گا۔",
    medcp_ask: "کیا آج آپ نے اپنی تمام ادویات لے لیں؟",
    medcp_btn_yes: "✅ جی ہاں",
    medcp_btn_no: "❌ نہیں",
    medcp_ack_yes: "🌟 بہت خوب — ایسے ہی جاری رکھیں۔",
    medcp_ack_no: "سچ بتانے کا شکریہ۔ عادت دوبارہ بنانے کے لیے ہم روزانہ چیک اِن پھر سے شروع کریں گے۔\n\nکیا آپ بتانا چاہیں گے کہ آج کیا رکاوٹ آئی؟",
    medcp_reason_forgot: "🤔 بھول گیا",
    medcp_reason_busy: "😴 مصروف تھا",
    medcp_reason_side_effects: "🤒 سائیڈ ایفیکٹس",
    medcp_reason_ranout: "💊 دوا ختم ہو گئی",
    medcp_reason_other: "کچھ اور",
    medcp_reason_saved: "نوٹ کر لیا۔ میں آگے اسے ذہن میں رکھوں گا۔",
    medsat_ask: "کیا آپ اپنی موجودہ ادویات سے مطمئن ہیں؟",
    medsat_btn_yes: "😊 جی ہاں",
    medsat_btn_notsure: "😐 یقین نہیں",
    medsat_btn_no: "☹️ نہیں",
    medsat_note_ask: "بتانے کا شکریہ۔ کیا آپ بتا سکتے ہیں کہ کیا بات پریشان کر رہی ہے؟",
    medsat_note_ack: "یہ بتانے کا شکریہ۔ کوئی بھی تبدیلی کرنے سے پہلے دوا سے متعلق اپنے خدشات اپنے ڈاکٹر سے ضرور ڈسکس کریں۔",
    reminder_template_med_consistency: "💊 اپنی ادویات لینا نہ بھولیں:\n{name}",
    foodhelp_analyze_prompt: "اپنے کھانے کی تصویر بھیجیں، یا بتائیں آپ کیا کھا رہے ہیں۔ 🍽️\nمیں کاربوہائیڈریٹس، پروٹین، چکنائی اور کیلوریز کا اندازہ لگاؤں گا، پھر بتاؤں گا کہ یہ کھانا آپ کی شوگر پر کیسے اثر کر سکتا ہے اور ضرورت ہو تو صحت مند متبادل تجویز کروں گا۔\n\n_مثالیں:_\n• چکن بریانی اور رائتہ\n• دو چپاتیاں چکن کڑاہی کے ساتھ\n• ایک سیب اور مٹھی بھر بادام",
    foodhelp_caneat_prompt: "آپ کیا کھانے کا سوچ رہے ہیں، یا آپ کے پاس کیا اجزا ہیں؟ 🥗\nمیں ذیابیطس کے لیے موزوں آپشنز تجویز کروں گا۔\n\n_مثالیں:_\n• ناشتے میں کیا کھا سکتا ہوں؟\n• میرے پاس انڈے، پالک اور ڈبل روٹی ہے۔\n• سحری کے آئیڈیاز\n• صحت مند رات کا کھانا\n• سبزی والا دوپہر کا کھانا",
    foodhelp_restaurant_prompt: "بتائیں آپ کس ریسٹورنٹ جا رہے ہیں یا کیا آرڈر کرنے کا سوچ رہے ہیں۔ 🍽️\nمیں سب سے صحت مند انتخاب میں مدد کروں گا۔\n\n_مثالیں:_\n• McDonald's\n• KFC\n• Kolachi\n• BBQ Tonight\n• Pizza Hut\n• میں بریانی کھا رہا ہوں",
    foodhelp_snacks_prompt: "اسنیک چاہیے؟ 🥜\nبتائیں کہ آپ کو بھوک لگی ہے، میٹھا کھانے کا دل چاہ رہا ہے، یا بس آئیڈیاز چاہییں۔\n\n_مثالیں:_\n• میٹھا کھانے کا دل\n• دفتر کا اسنیک\n• رات دیر کا اسنیک\n• زیادہ پروٹین والا اسنیک\n• 200 کیلوریز سے کم کچھ",
    foodhelp_label_prompt: "کسی بھی پیکٹ والے کھانے کے *Nutrition Facts* لیبل یا *اجزا کی فہرست* کی تصویر بھیجیں۔ 🏷️\nمیں بتاؤں گا اس کا کیا مطلب ہے اور کیا یہ ذیابیطس والے شخص کے لیے اچھا انتخاب ہے۔\n\n_مثالیں:_ بسکٹ، ناشتے کے سیریل، چپس، جوس، فروزن فوڈ، پروٹین بار، دہی، ڈبل روٹی۔\n\nمیں یہ بتاؤں گا:\n• کیلوریز، کاربس، اضافی چینی، فائبر، پروٹین، سرونگ سائز\n• ایک آسان درجہ بندی: 🟢 اچھا انتخاب / 🟡 کبھی کبھار ٹھیک / 🔴 کم سے کم کھائیں\n• جہاں مناسب ہو ایک صحت مند متبادل",
    foodhelp_meal_confirm: "✅ کھانے کا تجزیہ ہو گیا۔",
    foodhelp_label_confirm: "✅ نیوٹریشن لیبل کا تجزیہ ہو گیا۔",
    bs_offer_reminder: "کیا آپ شوگر چیک کرنے کی یاد دہانی چاہیں گے؟",
    bs_reminder_pick_time: "بہت خوب۔ دن کا کون سا وقت بہتر ہے؟ 24 گھنٹے والا وقت بھیجیں، مثلاً *08:00* (یا Skip لکھیں)۔",
    bs_reminder_pick_freq: "کتنی بار؟",
    btn_freq_daily: "روزانہ",
    btn_freq_3x_week: "ہفتے میں 3 بار",
    btn_freq_weekly: "ہفتہ وار",
    bs_reminder_saved: "✅ یاد دہانی محفوظ ہو گئی۔ میں *{time}* پر پوچھوں گا ({freq})۔",
    bs_reminder_skipped: "کوئی یاد دہانی سیٹ نہیں ہوئی۔ آپ کسی بھی وقت مزید ← یاد دہانیاں میں جا کر سیٹ کر سکتے ہیں۔",
    med_ask_name: "💊 کون سی دوا ہے؟ *نام اور خوراک* بھیجیں، مثلاً `Metformin 500mg` یا `Tagipmet XR 50/500`۔",
    med_existing_logged: "✅ *{name}* ریکارڈ ہو گئی۔ شاباش! 🔥 سلسلہ: {streak} دن",
    med_is_new_q: "لگتا ہے آپ پہلی بار *{name}* ریکارڈ کر رہے ہیں۔ کیا اسے اپنی ادویات کی فہرست میں شامل کریں؟",
    med_ask_frequency: "آپ *{name}* کتنی بار لیتے ہیں؟",
    btn_med_freq_once: "دن میں ایک بار",
    btn_med_freq_morn_eve: "صبح اور شام",
    btn_med_freq_three: "دن میں تین بار",
    btn_med_freq_other: "کچھ اور",
    med_other_freq: "آپ اسے کتنی بار لیتے ہیں؟ (مثلاً *ہفتے میں ایک بار*، *ہر 2 دن بعد*)۔",
    med_offer_reminder: "کیا آپ چاہیں گے کہ DrSaab باقاعدگی سے *{name}* لینے میں آپ کی مدد کرے؟",
    med_reminder_pick_time: "میں آپ کو کس وقت یاد دلاؤں؟ 24 گھنٹے والا وقت بھیجیں، مثلاً *08:00* (یا Skip لکھیں)۔",
    med_added_no_reminder: "✅ *{name}* آپ کی ادویات میں شامل ہو گئی (بغیر یاد دہانی کے)۔",
    med_added_with_reminder: "✅ *{name}* شامل ہو گئی، یاد دہانی *{time}* پر۔",
    weight_prompt: "⚖️ اپنا وزن *kg* میں بھیجیں، مثلاً `72.5 kg` یا صرف `72.5`۔",
    weight_saved: "✅ وزن ریکارڈ ہو گیا: *{value} kg*۔\n🔥 سلسلہ: {streak} دن",
    weight_offer_monthly: "کیا آپ وزن کرنے کی ماہانہ یاد دہانی چاہیں گے؟",
    weight_monthly_saved: "✅ وزن کی ماہانہ یاد دہانی سیٹ ہو گئی۔",
    activity_prompt: "🚶 آپ نے کیا کیا؟ مثالیں: `walked 30 minutes`، `gym 45 minutes`، `6500 steps`۔",
    activity_saved: "✅ سرگرمی ریکارڈ ہو گئی۔\n🔥 سلسلہ: {streak} دن",
    activity_ask_goal: "آپ کے خیال میں ہفتے میں کتنے دن آپ حقیقتاً متحرک رہ سکتے ہیں؟",
    activity_goal_saved: "✅ ہدف طے ہو گیا: *ہفتے میں {days} دن*۔ میں اسے ذہن میں رکھوں گا۔",
    symptoms_prompt: "🤒 آپ کو کون سی علامات محسوس ہو رہی ہیں؟ اپنے الفاظ میں بتائیں (مثلاً *سر درد، چکر، منہ خشک ہونا*)۔",
    symptoms_saved: "✅ نوٹ کر لیا۔ میں نے اسے آپ کے ریکارڈ میں شامل کر دیا۔",
    symptoms_coach_intro: "یہ چند باتیں قابلِ غور ہیں — لیکن اگر کچھ شدید لگے یا بگڑ جائے تو براہِ کرم ڈاکٹر سے رابطہ کریں۔",
    lab_offer_future_reminder: "کیا آپ اپنے اگلے HbA1c (تقریباً 3 ماہ بعد) کی یاد دہانی چاہیں گے؟",
    lab_reminder_saved: "✅ لیب ٹیسٹ کی یاد دہانی تقریباً 3 ماہ بعد کے لیے سیٹ ہو گئی۔",
    recent_title: "📝 *حالیہ سرگرمی* — پچھلے 7 دن",
    recent_none: "پچھلے 7 دنوں میں کوئی سرگرمی نہیں۔ مینو سے کچھ ریکارڈ کریں!",
    reminders_title: "⏰ *آپ کی یاد دہانیاں*",
    reminders_none: "آپ کی ابھی کوئی یاد دہانی نہیں ہے۔ ریکارڈ کرتے وقت جو یاد دہانیاں سیٹ کریں گے وہ یہاں نظر آئیں گی۔",
    reminder_row: "• {label} — {time}، {freq}",
    btn_reminder_cancel: "{label} منسوخ کریں",
    reminder_cancelled: "✅ یاد دہانی منسوخ ہو گئی۔",
    plan_title: "⭐ *میرا پلان*",
    plan_body: "موجودہ پلان: *{plan}*\n\nدیکھنے یا تبدیل کرنے کے لیے سبسکرپشن پر ٹیپ کریں۔",
    support_title: "🛟 *سپورٹ سے رابطہ*",
    support_body: "مدد چاہیے؟ ہم سے support@drsaabcoach.com پر رابطہ کریں — ہم عموماً 24 گھنٹوں میں جواب دیتے ہیں۔",
    reminder_template_glucose: "🩸 فوری چیک اِن: اپنی شوگر ریکارڈ کرنے کا وقت ہو گیا۔",
    reminder_template_medication: "💊 آپ کی *{name}* لینے کا وقت ہو گیا۔ ریکارڈ کرنے کے لیے ٹیپ کریں۔",
    reminder_template_weight: "⚖️ ماہانہ چیک اِن — آج اپنا وزن بھیجیں۔",
    reminder_template_lab: "🧪 آپ کے اگلے HbA1c کا وقت ہو گیا۔ جب ممکن ہو ٹیسٹ بک کروائیں۔",
    reminder_template_activity: "🚶 حرکت کا وقت — آج ایک مختصر چہل قدمی کیسی رہے گی؟",
  },
  ...
  roman_ur: {
    ...
    // ===== v2 onboarding journey =====
    smalltalk_thanks: "Aap ka shukriya! Jab bhi zaroorat ho main haazir hoon. Apni sehat ke baare mein kuch bhi poochein, ya saare options dekhne ke liye *menu* likhein.",
    smalltalk_ack: "👍 Ji bilkul. Koi sawal poochein, reading log karein (maslan `Fasting 110`), ya saare options dekhne ke liye *menu* likhein.",
    smalltalk_bye: "Apna khayal rakhein! Apni readings log karte rahein — jab zaroorat ho main yahin hoon. 💚",
    smalltalk_hello: "Assalamualaikum! Aaj main aap ki kya madad kar sakta hoon? Apni sehat ke baare mein kuch bhi poochein, ya saare options dekhne ke liye *menu* likhein.",
    wsum_title: "🗓 *Aap ke hafte ka khulasa*",
    wsum_readings: "🩸 Blood sugar: *{count}* readings, average *{avg} mg/dL* (kam az kam {min}, zyada se zyada {max}).",
    wsum_no_readings: "🩸 Is hafte koi blood sugar reading log nahi hui.",
    wsum_inrange: "🎯 In mein se *{pct}%* readings aap ki target range mein thin.",
    wsum_meds: "💊 Dawaiyan *{count}* baar log hui.",
    wsum_meds_none: "💊 Is hafte koi dawa log nahi hui.",
    wsum_checkins: "📝 Check-ins: *{count}*.",
    wsum_streak: "🔥 Aap ka *{days} din* ka streak chal raha hai — shabash.",
    wsum_watch_low: "⚠️ Ek ya zyada readings 70 mg/dL se kam thin. Low sugar ka zikr apne doctor se zaroor karein.",
    wsum_watch_high: "📈 Aap ka average zyada chal raha hai. Choti magar mustaqil tabdeeliyan is number ko badalti hain.",
    wsum_watch_mid: "📊 Aap ka average target se thora ooper hai — qareeb hain, ise aur kam karte rahein.",
    wsum_watch_good: "✅ Aap ka average sehatmand range mein hai. Jo kar rahe hain waise hi jaari rakhein.",
    wsum_focus_log_more: "*Agle hafte ki tawajjo:* rozana kam az kam ek reading log karein — din mein ek reading se bhi pattern ban jata hai.",
    wsum_focus_low: "*Agle hafte ki tawajjo:* har low reading se pehle aap ne kya aur kab khaya, ye note karein aur apne doctor ko batayein.",
    wsum_focus_range: "*Agle hafte ki tawajjo:* din ke sab se bhari khane ke baad 15 minute ki walk karein.",
    wsum_focus_meds: "*Agle hafte ki tawajjo:* rozana apni dawaiyan log karein taake hum dekh sakein wo aap ki readings se kaise juri hain.",
    wsum_focus_checkin: "*Agle hafte ki tawajjo:* rozana mukhtasar check-in karein taake aap ke hafte ki mukammal tasveer ban sake.",
    wsum_focus_keep: "*Agle hafte ki tawajjo:* apna mamool bilkul aise hi rakhein — tasalsul hi asal farq daalta hai.",
    joined_already: "Aap pehle hi join kar chuke hain! DrSaab mein khush aamdeed,",
    welcome_eng:
